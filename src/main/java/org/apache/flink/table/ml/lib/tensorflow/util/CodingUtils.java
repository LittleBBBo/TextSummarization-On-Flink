package org.apache.flink.table.ml.lib.tensorflow.util;
...
//    public static void configureExampleCoding(TFConfig config, String[] encodeNames, DataTypes[] encodeTypes,
//                                              String[] decodeNames, DataTypes[] decodeTypes,
//                                              ExampleCodingConfig.ObjectType entryType, Class entryClass) throws RuntimeException {
//        configureEncodeExampleCoding(config, encodeNames, encodeTypes, entryType, entryClass);
//        configureDecodeExampleCoding(config, decodeNames, decodeTypes, entryType, entryClass);
//    }

//    public static void configureExampleCoding(TFConfig config, TableSchema encodeSchema,
//                                              String[] decodeNames, DataTypes[] decodeTypes,
//                                              ExampleCodingConfig.ObjectType entryType, Class entryClass) throws RuntimeException {
//        String[] encodeNames = encodeSchema.getFieldNames();
...
//                                              ExampleCodingConfig.ObjectType entryType, Class entryClass) throws RuntimeException {
//        String[] decodeNames = decodeSchema.getFieldNames();
