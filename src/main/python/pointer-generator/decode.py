...
from tensorflow.python.training.monitored_session import WorkerSessionCreator, ChiefSessionCreator
...
class BeamSearchDecoder(object):
    ...
    def __init__(self, model, batcher, vocab, sess_config=None, server_target=None, writer=AbstractWriter()):
        ...
        if sess_config is None:
            ...
            self._sess = ChiefSessionCreator(master=server_target, config=sess_config).create_session()
